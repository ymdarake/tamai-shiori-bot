...
class MessageBuilderCreateHelper {
	 ...
	 */
	 private function genExternalLinkCarouselTemplateMessageBuilder() {
		$uriActions = [
			...
			["title" => "スケジュール", "description" => "ももいろクローバーZ スケジュール", "image" => APP_RESOURCE_PATH . "shao-e-shao-rect.jpg", "uri" => "http://momoirocloverz.blog.fc2.com/blog-entry-344.html"],
	...
	private function genPostbackCarouselTemplateMessageBuilder() {
		$postbackActions = [
			["title" => "玉井詩織", "description" => "わたしのニュースを検索するよ！", "image" => APP_RESOURCE_PATH . "shao-e-shao-rect.jpg", "data" => PostbackData::NEWS_SHIORI],
